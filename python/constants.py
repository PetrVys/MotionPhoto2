...
SAMSUNG_TAIL_SIZE = 107
SAMSUNG_TAIL_START = bytes([
    ...
    0x6d, 0x70, 0x76, 0x32   # "mpv2" - version 2 as a compatibility remnant :-)
])
SAMSUNG_TAIL_END = bytes([
    0x00, 0x00, 0x31, 0x0a,  # Motion Photo version header
    0x13, 0x00, 0x00, 0x00,  # 19 - length of string on next line
    0x4d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x68, 0x6f, 0x74, 0x6f, 0x5f, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6F, 0x6E,  # Human-readable tag name "MotionPhoto_Version"
    0x6d, 0x70, 0x76, 0x33,   # "mpv3" - I guess "Motion Photo version 3"?
    ...
    0x02, 0x00, 0x00, 0x00,   # Number of tags contained in the trailer (little-endian)
    0x00, 0x00, 0x30, 0x0a,   # Motion Photo Data tag header (again!)
    0x43, 0x00, 0x00, 0x00,   # Negative offset from start of the $samsungTailEnd into $samsungTailStart (including video offsets)
    0x24, 0x00, 0x00, 0x00,   # Length of the tag
    0x00, 0x00, 0x31, 0x0a,   # Motion Photo Data tag header (again!)
    0x1F, 0x00, 0x00, 0x00,   # Negative offset from start of the $samsungTailEnd into $samsungTailStart (including video offsets)
    0x1F, 0x00, 0x00, 0x00,   # Length of the tag
    0x24, 0x00, 0x00, 0x00,   # Length of the SEFH structure until previous line
